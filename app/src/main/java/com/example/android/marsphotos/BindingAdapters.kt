 ...
 * Jika permintaan memiliki kesalahan, ini akan menampilkan gambar yang rusak untuk mencerminkan
 * kesalahan koneksi. Ketika permintaan selesai, akan menyembunyikan tampilan gambar.
 */

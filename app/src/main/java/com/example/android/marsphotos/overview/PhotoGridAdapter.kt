 ...
 * menampilkan [List]data, termasuk menghitung perbedaan antara daftar.
 */
class PhotoGridAdapter :
    ...
    /**
     * Mengizinkan RecyclerView untuk menentukan item mana yang telah berubah ketika [List] dari
    ...
    /**
     * Membuat tampilan item [RecyclerView] baru (dipanggil oleh pengelola tata letak)
     */
